...
//Texto abaixo virou comentários após a criação do composer
...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    if ($num > 0) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            array_push($pizzas_arr, $pizza_item); // formato associativo, ou seja, cada pizza é um array associativo dentro do array de pizzas
        }
